...
\includegraphics[width=0.6\textwidth]{data/mushroom_copper_spike.jpg} \\
\includegraphics[width=0.7\textwidth]{data/mushroom_deadly_webcap.jpg} \\
\includegraphics[width=0.7\textwidth]{data/mushroom_false_chanterelle.jpg} \\
\includegraphics[width=0.7\textwidth]{data/mushroom_parasol_topview.jpg} \\
...
\includegraphics[width=\textwidth]{transcribing-svampboken.png}
...
\includegraphics[width=\textwidth]{wrong-answering.png}
